    ...
    <div class="col-md-12">
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                <li class="active"><a href="#tab_1" data-toggle="tab" aria-expanded="true"><b>Ventas por Producto</b></a></li>
            </ul>
            <div class="tab-content">
                <div class="tab-pane active" id="tab_1">
                    ...
                    <form id="formSaleForProducts" action="{{route('reports.sales.products')}}" method="POST">
                    <div class="row">
                        <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        <label class="container-radio success middle">Mes del año en curso
                                            <input type="radio" id="dateYearMonth" name="sale_date" value="date_year_month" @if(old('sale_date')=== 'date_year_month')) checked @endif
                                                   aria-describedby="error_status">
                                            <span class="checkmark-radio"></span>
                                        </label>
                                    ...
                                    <div class="col-md-2">
                                        <select id="saleMonth" class="form-control sel {{ (old('sale_date') === 'date_year_month') ? '' : 'hidden' }}" name="sale_month" data-placeholder="Seleccione un Mes">
                                            <option value=""><option>
