...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'first_name'            => '<i>Nombres</i>',
        'last_name'             => '<i>Apellidos</i>',
        'email'                 => '<i>Email</i>',
        'company_position_id'   => '<i>Cargo</i>',
        'role_id'               => '<i>Rol</i>',
        'address'               => '<i>Dirección</i>',
        'phone'                 => '<i>Telefono</i>',
        'name'                  => '<i>Nombre</i>',
        'description'           => '<i>Descripción</i>',
        'permissions'           => '<i>Permisos</i>',
        'password'              => '<i>Contraseña</i>',
        'price'                 => '<i>Precio</i>',
        'unit'                  => '<i>Unidad</i>',
        'code'                  => '<i>Código</i>',
        'status'                => '<i>Estado</i>',
        'products'              => '<i>Detalle de Productos</i>',
        'date'                  => '<i>Fecha</i>',
        'supplier'              => '<i>Proveedor</i>',
        'total'                 => '<i>Total</i>',
        'price_unit'            => '<i>Precio Unitario</i>',
        'quantity'              => '<i>Cantidad</i>',
        'client'                => '<i>Cliente</i>',
        'type'                  => '<i>Tipo de Movimiento</i>',
        'operation'             => '<i>Operación</i>',
        'product_code'          => '<i>Producto</i>',
    ],
